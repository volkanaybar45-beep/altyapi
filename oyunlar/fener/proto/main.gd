...
const BOAT_LANTERN := Vector2(189, 74)  # tekne.png içinde direk feneri (is10_varlik.py ölçer)
...
const UNITS_MAX := 13.2      # en uzun ızgara (hücre, üst 0.5 + alt 0.6 pay + ayna boşlukları)
